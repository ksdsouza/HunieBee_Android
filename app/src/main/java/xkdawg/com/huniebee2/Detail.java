...
public class Detail extends AppCompatActivity {
    private final String[] DETAIL_FILE_HEADERS = {"Age", "Education", "Height", "Weight", "Occupation", "Cup Size",
    ...
    private final String[] PREF_FILE_HEADERS = {"MDT", "LDT", "LovesGifts", "UniqueGifts", "LikesGifts", "LikesFood", "FavDrink", "AlcoholTolerance"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        window.setStatusBarColor(ContextCompat.getColor(this, R.color.statusTransparent));

        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,
                WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ctl = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        ctl.setExpandedTitleTextAppearance(R.style.DetailTheme_Expanded_Title);
        ctl.setCollapsedTitleTextAppearance(R.style.DetailTheme_Collapsed_Title);
    ...
    protected void onResume() {
        ...
        answer.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        ...
        for (int i = 0; i < 11; i++) {
            ...
            if ((girlName.equalsIgnoreCase("Kyu") || girlName.equalsIgnoreCase("Celeste") || girlName.equalsIgnoreCase("Venus")) && i == 1) {
                ...
                tv.setText(DETAIL_FILE_HEADERS[i]);
            }
            ...
            if ((girlName.equalsIgnoreCase("Kyu") || girlName.equalsIgnoreCase("Celeste") || girlName.equalsIgnoreCase("Venus")) && i == 1) {
                ...
                tv.setText(getInfo(DETAIL_FILE_HEADERS[i]));
            }
